...
TeamsFx helps to automate your development workflow while building Teams application. The following are the tools and templates you can use to set up CI/CD pipelines, create workflow templates, and customize CI/CD workflow with GitHub, Azure DevOps, Jenkins, and other platforms. To provision resources, you can create Azure service principals and use the Provision pipeline. To publish Teams app, you can use the Publish pipeline or do it mannualy by leveraging [Developer Portal for Teams](https://dev.teams.microsoft.com/home).

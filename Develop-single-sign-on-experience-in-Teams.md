...
Please Read this [Wiki](https://github.com/OfficeDev/TeamsFx/wiki/SSO-for-Message-Extension) for more detail about this API `handleMessageExtensionQueryWithSSO`
